...
\begin{center}
\huge{Lab 5: Pseudoscience}\\ \medskip 
\end{center}


\begin{quote}
``Anti-intellectualism has been a constant thread winding its way through our political and cultural life, nurtured by the false notion that democracy means that 'my ignorance is just as good as your knowledge.' '' \\
\hfill --- \textbf{Isaac Asimov}
\end{quote}

\vspace{0.5cm}

\section{Introduction}
What is science? What is pseudoscience? Why is it important to know the distinction as you navigate today's world?
\begin{itemize}
    \item Discuss with your classmates and briefly note your initial thoughts on this topic.
    \item How would you explain the difference between science and pseudoscience to a friend?
\end{itemize}
...
\begin{itemize}
    \item \textbf{Aries:} March 21 -- April 19
    \item \textbf{Taurus:} April 20 -- May 20
    \item \textbf{Gemini:} May 21 -- June 20
    \item \textbf{Cancer:} June 21 -- July 22
    \item \textbf{Leo:} July 23 -- August 22
    \item \textbf{Virgo:} August 23 -- September 22
    \item \textbf{Libra:} September 23 -- October 22
    \item \textbf{Scorpio:} October 23 -- November 21
    \item \textbf{Sagittarius:} November 22 -- December 19
    \item \textbf{Capricorn:} December 22 -- January 19
    \item \textbf{Aquarius:} January 20 -- February 18
    \item \textbf{Pisces:} February 19 -- March 20
\end{itemize}
...
Recall that the $!$ sign means ``factorial'', where $n$ factorial is the product of all integers equal to or less than $n$. For instance, $4! = 4 \times 3 \times 2 \times 1 = 24$. The probability of success $p$ is the chance that you achieve an outcome once in one trial. For example, if you flip a fair coin, the probability of it coming up heads is one in two, or $p=0.5$.
...
\begin{enumerate}
    ...
    \item Plot your results for the previous questions---that is, plot $P(k \mid n,p)$ versus $k$.
...
One of our TAs went down to the corner pharmacy (at 120th and Amsterdam) and sure enough, there were plenty of homeopathic remedies nestled between actual medicines.

\subsection*{Product Label Case Studies}
\textbf{Case Study 1: Homeopathic Allergy Remedy}
\begin{itemize}[noitemsep]
    \item \textbf{Active Ingredients HPUS:} Allium cepa 8X (Onion), Arsenicum album 8X (Arsenous oxide), Nux vomica 8X (Poison nut), Euphrasia officinalis 8X (Eyebright), Sabadilla 8X (Cevadilla), Sticta pulmonaria 8X (Lungwort), Aralia racemosa 8X (Spikenard), Cuprum metallicum 8X (Metallic copper).
    \item \textit{Disclaimer:} ``These claims have not been reviewed by the Food and Drug Administration. They are based on traditional homeopathic practice.''
\end{itemize}

\begin{enumerate}
    \setcounter{enumi}{3}
    \item Let's do a fun little comparison. The EPA has set the allowable concentration of arsenic in drinking water at 0.010 parts per million. How does the concentration of arsenic in your water compare to the concentration of onion, poison nut, etc. in this homeopathic remedy?
\end{enumerate}

\textbf{Case Study 2: Auro Earache Relief}
\begin{itemize}[noitemsep]
    \item \textit{Warning Notice:} ``Homeopathic drug products are required by law to conform to the Homeopathic Pharmacopeia of the United States (HPUS). They are not subject to a premarket approval process.''
\end{itemize}

The HPUS is the result of the Federal Food, Drug, \& Cosmetic Act of 1938, which created several loopholes in the normal drug-approval process that allow homeopathic remedies to forgo the normal FDA drug approval process. According to the FDA, ``a product's compliance with the requirements of the HPUS, USP, or NF does not establish that it has been shown by appropriate means to be safe, effective, and not misbranded for its intended use.'' \textit{(Source: CPG Sec. 400.400: Conditions Under Which Homeopathic Drugs May be Marketed, fda.gov)}

\begin{itemize}
    \item Discuss with your classmates and reflect on the implications of this policy.
\end{itemize}

Perhaps not surprisingly, there are many that take issue with the current US policy on homeopathic remedies. In 2011, a class action lawsuit was filed against Boiron, Inc., the company that sells a brand of the homeopathic flu treatment Oscillococcinum (Oscillo) that we examined above. The company was charged with false advertising, making misleading claims, etc. Oscillococcinum does not outperform placebo in scientific trials, and duck liver (the active ingredient) has no scientifically verified medical properties. The case settled out of court, with no admission of wrongdoing from Boiron. Asked whether Oscillo is safe, Boiron spokesperson Gina Casey replied ``Of course it is safe. There's nothing in it.'' \textit{(Sources: US News \& World Report, Top Class Actions)}
...
\subsubsection*{Answer in your notebook:}
\begin{enumerate}
